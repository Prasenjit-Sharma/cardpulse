  ...
  return (
    <svg className="card-stack" width={width} height={width * 0.73} viewBox="0 0 132 96" aria-hidden="true">
      ...
      <g>
        ...
        <circle cx="41" cy="41" r="6" style={{ fill: 'color-mix(in srgb, var(--brand) 22%, white)' }} />
        ...
        <path d="M32 62h14l4-9 6 17 5-11h15" fill="none" style={{ stroke: 'var(--brand)' }} strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
      </g>
    </svg>
  )
}
